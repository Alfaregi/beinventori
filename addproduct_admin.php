...
$imageData = str_replace('data:image/jpeg;base64,', '', $imageData); // Handle JPEG images  
$imageData = str_replace(' ', '+', $imageData);      
  
// Determine the file extension  
$fileExtension = strpos($image, 'data:image/png') === 0 ? 'png' : 'jpg'; // Default to jpg if not png  
$imageName = 'product_' . time() . '.' . $fileExtension; // Use the determined extension  
